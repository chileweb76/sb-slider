...
<div class="wrap">
    ...
    $active_tab = isset( $_GET['tab'] ) ? sanitize_text_field( wp_unslash( $_GET['tab'] ) ) : 'main_options';
    ?>
    ...
    <form action="options.php" method="post">
        <?php
        // Use a nonce to protect settings submission
        wp_nonce_field( 'sb_slider_save_settings', 'sb_slider_nonce' );
